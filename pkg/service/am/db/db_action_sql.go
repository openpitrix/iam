...
const sqlDescribeActionsBy_RoleId_Protal_new = `
select distinct
distinct t3.role_id,t3.role_name,t3.portal,t1.module_id,t1.module_name,
t1.feature_id,t1.feature_name,t2.data_level,
t1.action_id,
(case when isnull(t4.action_id)=0 then 'true' else 'false' end) as action_enabled,
t1.action_name ,t1.api_id,t1.api_method,
t1.url_method,t1.url
from action2 t1
left join role_module_binding t2 on t1.module_id=t2.module_id
left join role t3 on t2.role_id=t3.role_id  and t3.role_id='role_0002'
