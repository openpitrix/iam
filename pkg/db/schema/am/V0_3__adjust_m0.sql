...
('m0','默认权限','m0.f6','应用分类','m0.f6.a1','查看全部分类',0,0,0,'m0.f6.a1.api1','DescribeCategories','get','/v1/categories'),
('m0','默认权限','m0.f7','Job管理','m0.f7.a1','查看全部Job',0,0,0,'m0.f7.a1.api1','DescribeJobs','get','/v1/jobs'),
('m0','默认权限','m0.f8','Task管理','m0.f8.a1','查看全部Task',0,0,0,'m0.f8.a1.api1','DescribeTasks','get','/v1/tasks'),
('m0','默认权限','m0.f9','应用管理','m0.f9.a1','查看全部应用',0,0,0,'m0.f9.a1.api1','DescribeApps','get','/v1/apps'),
('m0','默认权限','m0.f9','应用管理','m0.f9.a1','查看全部应用',0,0,0,'m0.f9.a1.api3','DescribeActiveApps','get','/v1/active_apps'),
('m0','默认权限','m0.f9','应用管理','m0.f9.a1','查看全部应用',0,0,0,'m0.f9.a1.api4','DescribeAppVersions','get','/v1/app_versions'),
('m0','默认权限','m0.f9','应用管理','m0.f9.a1','查看全部应用',0,0,0,'m0.f9.a1.api5','DescribeActiveAppVersions','get','/v1/active_app_versions'),
('m0','默认权限','m0.f9','应用管理','m0.f9.a1','查看全部应用',0,0,0,'m0.f9.a1.api6','DescribeAppVersionAudits','get','/v1/app_version_audits'),
('m0','默认权限','m0.f9','应用管理','m0.f9.a1','查看全部应用',0,0,0,'m0.f9.a1.api7','GetAppVersionPackage','get','/v1/app_version/package'),
('m0','默认权限','m0.f9','应用管理','m0.f9.a1','查看全部应用',0,0,0,'m0.f9.a1.api8','GetAppVersionPackageFiles','get','/v1/app_version/package/files'),
('m0','默认权限','m0.f10','应用实例管理','m0.f10.a1','查看全部应用实例',0,0,0,'m0.f10.a1.api1','DescribeClusters','get','/v1/clusters'),
('m0','默认权限','m0.f10','应用实例管理','m0.f10.a1','查看全部应用实例',0,0,0,'m0.f10.a1.api2','DescribeClusterNodes','get','/v1/clusters/nodes'),
('m0','默认权限','m0.f10','应用实例管理','m0.f10.a1','查看全部应用实例',0,0,0,'m0.f10.a1.api3','DescribeAppClusters','get','/v1/clusters/apps'),
('m0','默认权限','m0.f10','应用实例管理','m0.f10.a1','查看全部应用实例',0,0,0,'m0.f10.a1.api4','DescribeDebugClusters','get','/v1/debug_clusters'),
('m0','默认权限','m0.f11','环境管理','m0.f11.a1','查看全部环境',0,0,0,'m0.f11.a1.api1','DescribeRuntimes','get','/v1/runtimes'),
('m0','默认权限','m0.f11','环境管理','m0.f11.a1','查看全部环境',0,0,0,'m0.f11.a1.api2','DescribeDebugRuntimes','get','/v1/debug_runtimes'),
('m0','默认权限','m0.f12','授权信息管理','m0.f12.a1','查看全部授权信息',0,0,0,'m0.f12.a1.api1','DescribeRuntimeCredentials','get','/v1/runtimes/credentials'),
('m0','默认权限','m0.f12','授权信息管理','m0.f12.a1','查看全部授权信息',0,0,0,'m0.f12.a1.api2','DescribeDebugRuntimeCredentials','get','/v1/debug_runtimes/credentials'),
