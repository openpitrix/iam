...
('m1','商店管理','m1.f2','应用审核','business_review','商务审核',1,0,0,'business_review.api1','BusinessAdminPassAppVersion','post','/v1/app_version/action/business_admin/pass'),
('m1','商店管理','m1.f2','应用审核','business_review','商务审核',1,0,0,'business_review.api2','BusinessAdminRejectAppVersion','post','/v1/app_version/action/business_admin/reject'),
('m1','商店管理','m1.f2','应用审核','business_review','商务审核',1,0,0,'business_review.api3','BusinessAdminReviewAppVersion','post','/v1/app_version/action/business_admin/review'),
('m1','商店管理','m1.f2','应用审核','business_review','商务审核',1,0,0,'business_review.api4','DescribeAppVersionReviews','get','/v1/app_version_reviews'),
('m1','商店管理','m1.f2','应用审核','technical_review','技术审核',1,0,0,'technical_review.api1','DevelopAdminPassAppVersion','post','/v1/app_version/action/develop_admin/pass'),
('m1','商店管理','m1.f2','应用审核','technical_review','技术审核',1,0,0,'technical_review.api2','DevelopAdminRejectAppVersion','post','/v1/app_version/action/develop_admin/reject'),
('m1','商店管理','m1.f2','应用审核','technical_review','技术审核',1,0,0,'technical_review.api3','DevelopAdminReviewAppVersion','post','/v1/app_version/action/develop_admin/review'),
...
('m1','商店管理','m1.f2','应用审核','isv_review','ISV审核',0,1,0,'isv_review.api1','IsvRejectAppVersion','post','/v1/app_version/action/isv/reject'),
('m1','商店管理','m1.f2','应用审核','isv_review','ISV审核',0,1,0,'isv_review.api2','IsvReviewAppVersion','post','/v1/app_version/action/isv/review'),
('m1','商店管理','m1.f2','应用审核','isv_review','ISV审核',0,1,0,'isv_review.api3','IsvPassAppVersion','post','/v1/app_version/action/isv/pass'),
