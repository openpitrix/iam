...
var (
	...
	ErrorRoleNotFound = ErrorMessage{
		Name: "role_not_found",
		en:   "role [%s] not found",
		zhCN: "没有找到角色[%s]",
	}
	ErrorModuleNotFound = ErrorMessage{
	...
	ErrorPortalNotFound = ErrorMessage{
		Name: "portal_not_found",
		en:   "portal [%s] not found",
		zhCN: "portal [%s]不存在",
	}
	...
	ErrorRoleNotInStatus = ErrorMessage{
		Name: "role_not_in_status",
		en:   "role [%s] is not in status [%s]",
		zhCN: "角色[%s]不处于[%s]状态",
	}
	...
	ErrorRoleAccessDenied = ErrorMessage{
		Name: "error_role_access_denied",
		en:   "access denied for role [%s]",
		zhCN: "拒绝访问角色[%s]",
	}
	...
	ErrorCannotBindRole = ErrorMessage{
		Name: "error_cannot_bind_role",
		en:   "cannot bind role",
		zhCN: "无法绑定角色",
	}
	ErrorCannotUnbindGroup = ErrorMessage{
		Name: "error_cannot_unbind_role",
		en:   "cannot unbind role",
		zhCN: "无法解绑角色",
	}
	ErrorStillUserBindingRole = ErrorMessage{
		Name: "error_still_user_binding_role",
		en:   "still users binding role",
		zhCN: "仍有用户绑定当前角色 ",
	}
	ErrorInternalRoleIllegalAction = ErrorMessage{
		Name: "internal_role_illegal_action",
		en:   "internal role illegal action",
		zhCN: "内置角色禁止操作",
	}
)
